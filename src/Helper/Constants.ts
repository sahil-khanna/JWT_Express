export class Constants {
    ...
    public static readonly INVALID_VERB = 'Invalid verb';
    public static readonly INVALID_TOKEN = 'Invalid token';
    public static readonly INVALID_TOKEN_CODE = 404;

    public static readonly INVALID_TOKEN_STATUS = 'Invalid token status';
    public static readonly UNAUTHORIZED_ACCESS = 'Unauthorized Access';
    public static readonly AUTHORIZED_ACCESS = 'Authorized';
    public static readonly UNAUTHORIZED_ACCESS_CODE = 403;
